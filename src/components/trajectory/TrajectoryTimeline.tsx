              ...
              >
                ...
                <div className="flex items-start justify-between gap-2">
                  ...
                  <div className="text-right">
                    <div className="text-xs font-mono font-bold text-yellow-400 flex items-center gap-1 justify-end">
                ...
                {!isFirst && (
                  <div className="mt-2.5 pt-2 border-t border-slate-800/80 grid grid-cols-3 gap-1 text-[11px] font-mono">
                    <div>
                      <span className="text-slate-400 text-[10px]">Distance (Δd):</span>
                      <div className="text-slate-200 font-semibold">{point.distanceFromPrevKm} km</div>
                    </div>
                    <div>
                      <span className="text-slate-400 text-[10px]">Elapsed (Δt):</span>
                      <div className="text-slate-200 font-semibold">{point.timeFromPrevMin} mins</div>
                    </div>
                    <div>
                      <span className="text-slate-400 text-[10px]">Inter-Node Speed:</span>
                      <div
                        className={`font-bold ${
                          point.isImpossibleSpeed
                            ? "text-rose-400"
