    ...
    <div className="space-y-5">
      ...
      <div className="bg-zinc-950/80 border border-zinc-800 rounded-xl p-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-mono text-base font-black tracking-wide text-white uppercase">
        ...
        <div className="p-4 rounded-xl bg-zinc-950/70 border border-zinc-800 space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-mono text-xs font-bold uppercase text-zinc-200">
          ...
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={comparisonData} margin={{ top: 10, right: 10, left: -20, bottom: 20 }}>
                ...
                <XAxis dataKey="condition" stroke="#71717a" tick={{ fontSize: 10 }} interval={0} angle={-15} textAnchor="end" />
                <YAxis stroke="#71717a" tick={{ fontSize: 10 }} domain={[0, 100]} />
                <Tooltip
                  contentStyle={{ backgroundColor: "#09090b", borderColor: "#27272a", borderRadius: 8, fontSize: 12, fontFamily: "monospace", color: "#ffffff" }}
                  formatter={(val: any) => [`${val}%`, ""]}
                />
                <Legend wrapperStyle={{ fontSize: 11, fontFamily: "monospace" }} />
                <Bar dataKey="standardAnprOcr" name="Standard ANPR (OCR Only)" fill="#52525b" radius={[4, 4, 0, 0]} />
                <Bar dataKey="sentinelMultiModal" name="Sentinel Multi-Modal Fusion" fill="#ffffff" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
            ...
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={hourlyData} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
                ...
                <Tooltip
                  contentStyle={{ backgroundColor: "#09090b", borderColor: "#27272a", borderRadius: 8, fontSize: 12, fontFamily: "monospace", color: "#ffffff" }}
                />
                <Area type="monotone" dataKey="detections" stroke="#ffffff" fillOpacity={1} fill="url(#colorDetections)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
          <div className="text-[11px] font-mono text-zinc-400 text-center">
      ...
      <div className="p-5 rounded-xl bg-zinc-950 border border-zinc-800 space-y-4 shadow-2xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 pt-2">
          ...
          <div className="p-3 rounded-lg bg-zinc-900/60 border border-zinc-800 space-y-2">
            <div className="flex justify-between text-xs font-mono">
              <span className="text-zinc-300">w₁: Plate OCR</span>
              <span className="text-white font-bold">{weights.ocr}%</span>
            </div>
            <input
              type="range"
              min="10"
          ...
          <div className="p-3 rounded-lg bg-zinc-900/60 border border-zinc-800 space-y-2">
            <div className="flex justify-between text-xs font-mono">
              <span className="text-zinc-300">w₂: Deep Re-ID</span>
              <span className="text-white font-bold">{weights.reId}%</span>
            </div>
            <input
              type="range"
              min="10"
          ...
          <div className="p-3 rounded-lg bg-zinc-900/60 border border-zinc-800 space-y-2">
            <div className="flex justify-between text-xs font-mono">
              <span className="text-zinc-300">w₃: Color Hist</span>
              <span className="text-white font-bold">{weights.color}%</span>
            </div>
            <input
              type="range"
              min="5"
          ...
          <div className="p-3 rounded-lg bg-zinc-900/60 border border-zinc-800 space-y-2">
            <div className="flex justify-between text-xs font-mono">
              <span className="text-zinc-300">w₄: Body Type</span>
              <span className="text-white font-bold">{weights.type}%</span>
            </div>
            <input
              type="range"
              min="5"
          ...
          <div className="p-3 rounded-lg bg-zinc-900/60 border border-zinc-800 space-y-2">
            <div className="flex justify-between text-xs font-mono">
              <span className="text-zinc-300">w₅: Spatio-Temp</span>
              <span className="text-white font-bold">{weights.spatioTemporal}%</span>
            </div>
            <input
              type="range"
              min="5"
